...
<form method="post" action="/admin/news/store" enctype="multipart/form-data" class="admin-form">
  ...
  <div class="list">
    <?php foreach ($news as $item): ?>
      <div class="row">
        ...
        <div>
          <form method="post" action="/admin/news/delete" onsubmit="return confirm('Slet nyhed?');">
            <input type="hidden" name="newsID" value="<?= (int)$item['newsID'] ?>">
